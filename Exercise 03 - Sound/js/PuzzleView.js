var PuzzleView = function (canvas_id, width, height, multimediaFiles){
	...
	function selectPieceEffect(_mouse, _currentPiece,_pieceWidth, _pieceHeight){
		...
		this.stage.drawImage(multimediaFiles["puzzleImage"], _currentPiece.sx, _currentPiece.sy, _pieceWidth, _pieceHeight, _mouse.x - (_pieceWidth / 2), _mouse.y - (_pieceHeight / 2), _pieceWidth, _pieceHeight);
		this.stage.restore();	
	}		
}
...
PuzzleView.prototype.init = function() {
	...
	this.stage.drawImage(this.multimediaFiles["puzzleImage"], 0, 0, this.canvasWidth, this.canvasHeight, 0, 0, this.canvasWidth, this.canvasHeight);	
...
PuzzleView.prototype.drawScenario  = function(_pieces, _pieceWidth, _pieceHeight){	
	...
	for(i = 0;i < _pieces.length;i++){	
		...
		piece.xPos = xPos;			
		piece.yPos = yPos;
		this.stage.drawImage(this.multimediaFiles["puzzleImage"], piece.sx, piece.sy, _pieceWidth, _pieceHeight, xPos, yPos, _pieceWidth, _pieceHeight);
...
PuzzleView.prototype.movePieceEffect = function(_mouse,_currentPiece,_pieces,_pieceWidth,_pieceHeight){
	...
	for(i = 0;i < _pieces.length;i++){
		...
		this.stage.drawImage(this.multimediaFiles["puzzleImage"], piece.sx, piece.sy, _pieceWidth, _pieceHeight, piece.xPos, piece.yPos, _pieceWidth, _pieceHeight);
	...
	this.stage.drawImage(this.multimediaFiles["puzzleImage"], _currentPiece.sx, _currentPiece.sy, _pieceWidth, _pieceHeight, _mouse.x - (_pieceWidth / 2), _mouse.y - (_pieceHeight / 2), _pieceWidth, _pieceHeight);
	this.stage.restore();
